...
const CoreValue: React.FC = () => {
    return (
        <>
            <div className=' max-w-[1426px] mx-auto px-4 py-20  ' >
                <h1 className=' text-[#000000] text-[35px] font-bold leading-9 text-center ' >Our core values</h1>
                <div className=' flex flex-row justify-between mt-20 ' >
                    <div className=' max-w-[390px] ' >
                        <div className=' flex items-center gap-x-5 ' >
                            <div className=' w-[54px] h-[54px] rounded-full bg-[#D9D9D9] ' ></div>
                            <div><h1 className=' text-[#000000] font-bold text-lg leading-6  ' >We’ve got each other’s back</h1></div>
                        </div>
                        <div className=' mt-5 ' >
                            <p className=' text-[#000000] leading-6 text-lg ' >
                    ...
                    <div className=' max-w-[390px] ' >
                        <div className=' flex items-center gap-x-5 ' >
                            <div className=' w-[54px] h-[54px] rounded-full bg-[#D9D9D9] ' ></div>
                            <div><h1 className=' text-[#000000] font-bold text-lg leading-6  ' >We are actively responsible</h1></div>
                        </div>
                        <div>
                            <p className=' text-[#000000] leading-6 text-lg mt-5 ' >
                    ...
                    <div className=' max-w-[390px] ' >
                        <div className=' flex items-center gap-x-5 ' >
                            <div className=' w-[54px] h-[54px] rounded-full bg-[#D9D9D9] ' ></div>
                            <div><h1 className=' text-[#000000] font-bold text-lg leading-6  ' > If we say it, we do it</h1></div>
                        </div>
                        <div className='mt-5' >
                            <p className=' text-[#000000] leading-6 text-lg ' >
