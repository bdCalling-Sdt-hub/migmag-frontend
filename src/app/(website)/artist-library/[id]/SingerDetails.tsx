...
const SingerDetails: React.FC = () => {
    ...
    const tracks: Track[] = [
        {
            ...
            license: 'PREMIUM',
            price: 120,
            image: '/images/home-page/trending-img/slide-2.png',
    ...
    return (
        <div className=' max-w-[1539px] mx-auto px-4 mt-20   ' >
                    ...
                    <div className=' flex flex-col lg:flex-row lg:gap-x-16 ' >
                        ...
                        <div>
                            ...
                            <div className=' flex items-center gap-x-[18px] mt-2.5  ' >
                                <span>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="16" y="12" width="4" height="7" rx="2" stroke="#818080" stroke-width="2" stroke-linejoin="round" />
                                        <rect x="4" y="12" width="4" height="7" rx="2" stroke="#818080" stroke-width="2" stroke-linejoin="round" />
                                        <path d="M4 13V16" stroke="#818080" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M20 13V16" stroke="#818080" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M20 13C20 10.6131 19.1571 8.32387 17.6569 6.63604C16.1566 4.94821 14.1217 4 12 4C9.87827 4 7.84344 4.94821 6.34315 6.63604C4.84286 8.32387 4 10.6131 4 13" stroke="#818080" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                            ...
                            <button className=' flex cursor-pointer  items-center gap-x-2.5 lg:gap-x-5 text-sm lg:text-2xl lg:px-7 px-3.5 py-1 lg:py-1.5 border border-black rounded-2xl  ' >
                                <span>
                                    <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M13.125 14.5834L21.875 14.5834" stroke="#222222" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M13.125 20.4166H17.5" stroke="#222222" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M27.7085 11.6666L27.7085 2.91663M23.3335 7.29163H32.0835" stroke="#222222" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
            ...
            <div className=' flex flex-col lg:flex-row justify-between items-center px-4 lg:space-y-0 space-y-4 lg:gap-x-11 mt-[66px] ' >
