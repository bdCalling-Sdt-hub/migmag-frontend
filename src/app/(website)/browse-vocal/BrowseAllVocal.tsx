...
const BrowseAllVocal = () => {
    ...
    const bpm: string[] = ["60", "80", "100", "120", "140", "160"];
                            ...
                            >
                                {bpm.map((bpm) => (
                                    ...
                                    >
                                        <input
                                            type="checkbox"
                                            checked={selectedBPM.includes(bpm)}
                                            onChange={(e) => {
                                                toggleBPM(bpm);
                                                handleFilterChange('bpm', e.target.checked ? bpm : '');
                                            }}
                                            className="mr-3 accent-indigo-500 w-5 h-5"
                                        />
                                        <span className="text-white md:text-lg  ">{bpm}</span>
                                    </label>
                                ))}
                            </motion.div>
                        )}
