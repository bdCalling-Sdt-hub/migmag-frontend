...
const LicenseBadge = ({ type }: { type: Track['license'] }) => {
    const colorMap = {
        PREMIUM: 'bg-cyan-500 text-white lg:text-[12px] text-[10px] lg:px-6 py-2 ',
        'NON-EXCLUSIVE': 'bg-gray-600 lg:text-[12px] text-[10px] text-white lg:px-6 py-2 ',
        EXCLUSIVE: 'bg-lime-500 lg:text-[12px] text-[10px] text-black lg:px-6 py-2 ',
    };
    return (
                    ...
                    <tbody className=' space-y-5 ' >
                        {tracks.map((track, index) => (
                            <tr key={track.id} className={index % 2 === 0 ? "bg-black" : "bg-gray-800"}>
                                ...
                                {/* Track Info */}
                                <td className="lg:px-6 px-3 py-3 text-[10px] lg:text-xl font-bold">{track.title}</td>
                                <td className="lg:px-6 px-3 py-3 text-[10px] lg:text-xl">{track.artist}</td>
                                <td className="lg:px-6 px-3 py-3 text-[10px] lg:text-xl">{track.genre}</td>
                                <td className="lg:px-6 px-3 py-3 text-[10px] lg:text-xl">{track.bpm}</td>
                                <td className="lg:px-6 px-3 py-3 text-[10px] lg:text-xl">{track.key}</td>
                                <td className="lg:px-6 px-3 py-3 text-[10px] lg:text-xl">{track.gender}</td>

                                {/* License */}
                                <td className="lg:px-4 px-2 py-3 text-center">
