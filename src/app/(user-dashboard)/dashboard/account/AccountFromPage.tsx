...
const AccountFromPage: React.FC = () => {
    ...
    return (
        ...
        <form className=" border border-[#E7E7E7] bg-[#FFFFFF] rounded-3xl p-8 mt-4 lg:mt-6 ">
            <div className="flex flex-col items-center">
                <label htmlFor="photo-upload" className="cursor-pointer">
                    <div className="w-28 h-28 border border-dashed border-gray-400 rounded-xl flex items-center justify-center bg-gray-100">
                        {image ? (
                            <img src={image} alt="Uploaded" className="w-full h-full object-cover rounded-xl" />
                        ) : (
                            <svg className="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 16l4-4a4 4 0 015.66 0l4.34 4.34M3 8h.01M21 21H3a2 2 0 01-2-2V5a2 2 0 012-2h18a2 2 0 012 2v14a2 2 0 01-2 2z" />
                            </svg>
                        )}
                    </div>
                </label>
